...
class Deme(object):
    ...
    def add_cell(self, cell):
        cell.genotype_id = '000' + str(cell.genotype_id)
        self.cells.add(cell)
    ...
    def update(self, treat=False, treatment_target=None, rng=None):
        ...
        for i, cell in enumerate(cells):
            if treat and cell.snvs[treatment_target] == 1:
            ...
            if success:
                if event == "death":
                    ...
                    new_cell.set_params()
                    if cell.type == "tumor":
                        mutate = rng.binomial(1, self.mutation_rate)
                        ...
                        if mutate:
                            ...
                            disperse = rng.binomial(1, self.dispersal_rate)
                            if disperse:
