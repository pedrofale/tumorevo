...
class Deme(object):
	def __init__(self, cell, carrying_capacity=1, mutation_rate=.05, death_rate=0.98):
	...
	def update(self):
		...
		cells = np.random.choice(list(self.cells), size=min(10, len(self.cells)), replace=False)
